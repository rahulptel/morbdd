...
public:
    ...
    void merge(ParetoFrontier &frontier, int arc_type, const ObjType *shift);
...
// Merge pareto frontier into existing set considering shift
//
inline void ParetoFrontier::merge(ParetoFrontier &frontier, int arc_type, const ObjType *shift)
{
