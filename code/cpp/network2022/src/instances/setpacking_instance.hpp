...
struct SetPackingInstance
{
	...
	SetPackingInstance(int n_vars, int n_cons, int n_objs, vector<vector<int>> objs, vector<vector<int>> vars_cons);
...
inline SetPackingInstance::SetPackingInstance(int _n_vars, int _n_cons, int _n_objs, vector<vector<int>> _objs, vector<vector<int>> _vars_cons)
{
	n_vars = _n_vars;
	n_cons = _n_cons;
	n_objs = _n_objs;
	objs = _objs;
	vars_cons = _vars_cons;
}
